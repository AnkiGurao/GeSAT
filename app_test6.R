        ...
        tabPanel("Delta Ct",
                 fluidRow(
                   column(3,
                          wellPanel(
                            h4("Controls"),
                            # select a single gene pair or show all
                            uiOutput("pair_selector_ui"),    # dynamic UI created below
                            checkboxInput("show_jitter", "Show jitter points", value = TRUE),
                            sliderInput("annotation_y", "Annotation Y position", min = -20, max = 50, value = 12, step = 1),
                            br(),
